...
function dataRequest() {
    ...
    dataReq.onreadystatechange = handleDataReq;
    url = "SubmitCartServlet" + "?timeStamp=" + new Date().getTime();
    for(i=0;i<idArray.length;i++){
        url = url + "&id" + (i+1) + "=" + idArray[i]; 
    }
    url = url + "&length" + "=" + idArray.length; 
    alert(url);
    dataReq.open("GET", url, true);
    dataReq.send(null);
}
function handleDataReq() {
